        ...
        <div class="row">
          ...
          <div class="col-sm-8">
            <div class="panel-body frameLR bg-white shadow mTop-30">
              ...
              <p>
                Ripple effect requiers JS for creating DOM-element and controlling animation. Animation work on CSS3. If you want to use this effect, you should add class
                <code>
                  .ripple-effect
                </code>
                to your button.
