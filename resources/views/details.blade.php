    ...
    <div class="col-lg-8 col-sm-7">
      <div class="post-media">
        <div id="slider" class="flexslider">
          <ul class="slides">
            <li>
              <img class="img-responsive" alt="" src="http://placehold.it/900x600">
            </li>
            <li>
              <img class="img-responsive" alt="" src="http://placehold.it/900x600">
            </li>
        ...
        <div class="col-sm-4 col-lg-3 bg-light">
          <article class="side-details">
            ...
            <div class="what-you-get">
              ...
              <ul>
                <li>
                  Daily breakfast, lunch, and dinner for two from the regular menus at the Circle Wine Bar and Cellar,
                  Amalgama, Ginger Pool Bar, and Vieques del Mar Beach restaurants
                </li>
                <li>
                      ...
                      <section class="tab-content">
                        ...
                        <form action="#" method="post" id="comment-form" class="comments" novalidate="novalidate">
                          <fieldset>
                            ...
                            <div class="space-xs">
                              <div>
                                <textarea rows="8" name="message" id="message" placeholder="Write comment here ..."
                                  class="form-control">
                                                          </textarea>
                              </div>
                            </div>
        ...
        <div class="buyPanel animated fadeInLeft bg-white Aligner text-center">
          <div class="content">
            ...
            <div class="buy-now mBtm-30">
              <a class="btn btn-success btn-lg btn-raised ripple-effect btn-block" data-toggle="modal"
                data-target="#myModal">
                BUY NOW
            ...
            <div class="dealAttributes">
              ...
              <div class="social-sharing text-center"
                data-permalink="http://labs.carsonshold.com/social-sharing-buttons">
                <!-- https://developers.facebook.com/docs/plugins/share-button/ -->
                <a target="_blank" href="http://www.facebook.com/sharer.php?u=http://themeforest.net/user/codenpixel"
                ...
                <a target="_blank" href="http://twitter.com/share?url=http://themeforest.net/user/codenpixel"
                  class="share-twitter">
            ...
            <div class="content">
              <ul class="tick">
                ...
                <li>
                  ...
                  as you swim beneath a cascading waterfall in the outdoor pool, where you can watch dive-in movies on
