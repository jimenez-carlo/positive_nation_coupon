                                        ...
                                        <div class="row">
                                            <div class=" mTop-30 col-sm-9 col-sm-offset-3" id="wizardControl">
                                                <div class="wizNav">
                                                    ...
                                                    <a class="btn btn-primary btn-raised ripple-effect" href="#step1" data-toggle="tab">
                                Step 1 - Your Info
                              </a>
                                                    <a class="btn btn-default btn-raised ripple-effect" href="#step2" data-toggle="tab">
                                Step 2 - Deal info and Payment data
                              </a>
                                                    <a class="btn btn-default btn-raised ripple-effect" href="#step3" data-toggle="tab">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-lg-6">
                                                                ...
                                                                <input type="password" value="" id="" class="form-control" name="" placeholder="******">
                                                            </div>
                                                            <div class="form-group col-lg-6">
                                                                <label>
                                                                    Company
                                                                </label>
                                                                <input type="text" value="" id="" class="form-control" name="" placeholder="Company Name">
                                                            </div>
                                                            <div class="form-group col-lg-6">
                                                                <label>
                                                                    Email Address
                                                                </label>
                                                                <input type="" value="" id="" class="form-control" name="" placeholder="user@email.com">
                                                            </div>
                                                            <div class="form-group col-lg-6">
                                                                <label>
                                                                    Country
                                                                </label>
                                                                <input type="text" value="" id="" class="form-control" name="" placeholder="UK">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-9">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-lg-12">
                                                                ...
                                                                <input type="" value="" id="" class="form-control" name="dealname" placeholder="Deal name">
                                                            </div>
                                                            <div class="form-group col-lg-6">
                                                                <label>
                                                                    Deal Value
                                                                </label>
                                                                <input type="password" value="" id="" class="form-control" name="" placeholder="Deal price">
                                                            </div>
                                                            <div class="form-group col-lg-6">
                                                                <label>
                                                                    Asking price
                                                                </label>
                                                                <input type="text" value="" id="" class="form-control" name="" placeholder="Asking price">
                                                            </div>
                                                            <div class="form-group col-lg-6">
                                                                <label>
                                                                    Discount
                                                                </label>
                                                                <input type="" value="" id="" class="form-control" name="" placeholder="Discount">
                                                            </div>
                                                            <div class="form-group col-lg-6">
                                                                <label>
                                                                    Country
                                                            ...
                                                            <div class="form-group col-lg-6">
                                                                ...
                                                                <input type="password" value="" id="" class="form-control" name="" placeholder="Enter date">
                                                            </div>
                                                            <div class="form-group col-lg-6">
                                                                <label>
                                                                    Valid to
                                                                </label>
                                                                <input type="text" value="" id="" class="form-control" name="" placeholder="Valid to">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
